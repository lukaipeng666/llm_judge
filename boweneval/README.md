...
```jsonl
{"meta":{"mata_description": "请回答以下问题", "human": "什么是人工智能？", "assistant": "人工智能是..."}}
{"meta":{"mata_description": "翻译下列句子", "human": "Hello World", "assistant": "你好，世界"}}
```

**必需字段**：
- `mata_description`: 任务指令
- `human`: 输入文本
- `assistant`: 期望输出（用于评分对比）
